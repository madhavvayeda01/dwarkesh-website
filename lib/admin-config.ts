export const ADMIN_PAGE_DEFINITIONS = [
  ...
  { key: "shift_master", label: "Shift Master", href: "/admin/shift-master", group: "ops", groupLabel: "Operations" },
  ...
  { key: "audit_calendar", label: "Audit Calendar", href: "/admin/audit/calendar", group: "audit", groupLabel: "Audit Module" },
