  ...
  async function generatePfFile() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setStatus(data?.message || "Failed to generate PF challan file.");
        return;
      }
    ...
    <div className="flex min-h-screen bg-slate-100">
      ...
      <main className="flex-1 p-8">
        {moduleEnabled === false ? (
          ...
          <>
            <h1 className="text-2xl font-bold text-blue-950">PF Challan</h1>
            <p className="mt-2 text-slate-600">
              Generate PF site compatible challan file from saved payroll data.
            </p>
