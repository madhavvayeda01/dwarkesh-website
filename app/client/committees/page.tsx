...
export default function ClientCommitteesPage() {
  ...
  useEffect(() => {
    async function checkLoginAndLoad() {
      ...
      const res = await fetch("/api/client/generated-files?module=committees");
    ...
    <div className="flex min-h-screen bg-slate-100">
      ...
      <main className="flex-1 p-8">
        {moduleEnabled === false ? (
          ...
          <>
        <h1 className="text-2xl font-bold text-blue-950">Committees</h1>
        <p className="mt-1 text-slate-600">Committee meeting files generated by admin.</p>

        <div className="mt-6 rounded-2xl bg-white p-6 text-slate-900 shadow">
          {files.length === 0 ? (
            <p className="text-sm text-slate-600">No committee files available yet.</p>
          ) : (
